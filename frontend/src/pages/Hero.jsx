...
const Hero = () => {
    ...
    return (
        <>
            ...
            {/* for SEO purposes */}
            <Helmet >
                <title>TripTribe - Your AI Travel Planner</title>
                <meta name="description" content="Plan your trips with AI-powered personalized itineraries" />
                <meta name="keywords" content="travel, AI itinerary, trip planner, TripTribe" />
                <meta property="og:title" content="TripTribe - Your AI Travel Planner" />
                <meta property="og:description" content="AI-generated personalized travel itineraries." />
